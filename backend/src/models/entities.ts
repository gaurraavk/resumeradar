...
export interface UserEntity { id: string; name: string; email: string; username?: string; mobile?: string; passwordHash: string; salt: string; role: UserRole; plan: string; targetRole: string; scansRemaining: number; maxQuota: number; status: UserStatus; avatarUrl?: string; createdAt: string; updatedAt: string; }
